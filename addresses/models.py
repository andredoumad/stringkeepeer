...
class Address(models.Model):
    ...
    name            = models.CharField(max_length=120, null=True, blank=True, help_text='Your name')
    nickname        = models.CharField(max_length=120, null=True, blank=True, help_text='Your nickname')
